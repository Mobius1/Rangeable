...
*/
var createElement=function(a,b){var c=document.createElement(a);if("string"===typeof b)c.classList.add(b);else if(b===Object(b))for(var d in b)d in c?c[d]=b[d]:c.setAttribute(c[d],b[d]);return c},isFunction=function(a){return a&&"function"===typeof a},throttle=function(a,b,c){var d;return function(){c=c||this;if(!d)return a.apply(c,arguments),d=!0,setTimeout(function(){d=!1},b)}},Rangeable=function(a,b){"string"===typeof a&&(a=document.querySelector(a));this.input=a;this.config=Object.assign({},{tooltip:!0,
showTooltips:!0,multiple:!1,classes:{input:"ranger-input",container:"ranger-container",vertical:"ranger-vertical",progress:"ranger-progress",handle:"ranger-handle",tooltip:"ranger-tooltip",track:"ranger-track",multiple:"ranger-multiple"}},b);this.mouseAxis={x:"clientX",y:"clientY"};this.trackSize={x:"width",y:"height"};this.trackPos={x:"left",y:"top"};this.touch="ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch;this.init();this.onInit()};
...
Rangeable.prototype.render=function(){var a=this.config,b=a.classes,c=createElement("div",b.container),d=createElement("div",b.track),e=createElement("div",b.progress),f=createElement("div",b.handle),g=createElement("div",b.tooltip);d.appendChild(e);this.config.multiple?(f=[createElement("div",b.handle),createElement("div",b.handle)],g=[createElement("div",b.tooltip),createElement("div",b.tooltip),createElement("div",b.tooltip)],f.forEach(function(a,b){a.index=b;e.appendChild(a);a.appendChild(g[b])}),
this.config.vertical&&e.appendChild(f[0]),e.appendChild(g[2]),c.classList.add(b.multiple)):(e.appendChild(f),f.appendChild(g));this.nodes={container:c,track:d,progress:e,handle:f,tooltip:g};c.appendChild(d);a.vertical&&c.classList.add(b.vertical);a.size&&(c.style[this.trackSize[this.axis]]=isNaN(a.size)?a.size:a.size+"px");a.tooltip&&c.classList.add("has-tooltip");this.config.showTooltips&&c.classList.add("show-tooltip");this.input.parentNode.insertBefore(c,this.input);c.insertBefore(this.input,d);
this.input.classList.add(b.input);this.bind();this.update()};Rangeable.prototype.reset=function(){this.setValue(this.input.defaultValue);this.onEnd()};
...
Rangeable.prototype.destroy=function(){this.input.ranger&&(this.unbind(),this.input.classList.remove(this.config.classes.input),this.nodes.container.parentNode.replaceChild(this.input,this.nodes.container),delete this.input.ranger)};Rangeable.prototype.onInit=function(){isFunction(this.config.onInit)&&this.config.onInit.call(this,this.input.value)};Rangeable.prototype.onChange=function(){isFunction(this.config.onChange)&&this.config.onChange.call(this,this.input.value)};
Rangeable.prototype.onEnd=function(){isFunction(this.config.onEnd)&&this.config.onEnd.call(this,this.input.value)};
Rangeable.prototype.bind=function(){this.listeners={down:this.down.bind(this),touchstart:this.touchstart.bind(this),move:this.move.bind(this),up:this.up.bind(this),update:this.update.bind(this),change:this.change.bind(this),reset:this.reset.bind(this)};this.listeners.scroll=throttle(this.listeners.update,100);this.listeners.resize=throttle(this.listeners.update,50);document.addEventListener("scroll",this.listeners.scroll,!1);window.addEventListener("resize",this.listeners.resize,!1);this.input.addEventListener("change",
